...
const GamePlayScreen = props => {
    ...
    return (
        <View style={styles.container}>
            ...
            <GamePlayContainer>
                <ImageScrollZoom source={require('../assets/ImageIcon.png')} buttonPress={props.buttonPress} pageName='roundWon' toggleTimer={toggleTimer} endTimer={endTimer} postNewTime={postNewTime} bestTime={bestSeconds} />
            </GamePlayContainer>
